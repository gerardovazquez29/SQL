...
INSERT INTO Desarrolladores (DesarrolladorID,Nombre, Pais) VALUES 
('Naughty Dog', 'Estados Unidos'),
('Nintendo', 'Japón'),
('CD Projekt Red', 'Polonia');

-- Insertar datos en la tabla Plataformas
INSERT INTO Plataformas (plataformaId, Nombre, Tipo) VALUES 
('PlayStation 4', 'Consola'),
('Nintendo Switch', 'Consola'),
('PC', 'Computadora');

-- Insertar datos en la tabla Juegos
INSERT INTO Juegos (juegoID, Titulo, AñoLanzamiento, DesarrolladorID, PlataformaID) VALUES 
